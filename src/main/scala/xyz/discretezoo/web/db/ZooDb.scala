...
import xyz.discretezoo.web.db.MBGENMatrixWithCharacteristicS.{MatrixWithCharacteristicSPlainQuery, MatrixWithCharacteristicSTable}
import xyz.discretezoo.web.db.MBGENMatrixWithCharacteristicSView.{MatrixWithCharacteristicSViewPlainQuery, MatrixWithCharacteristicSViewTable}
import xyz.discretezoo.web.db.MBGENMatrixS.{MatrixSPlainQuery, MatrixSTable}
...
object ZooDb {
  ...
  object tbMatrixWithCharacteristicSView extends TableQuery(new MatrixWithCharacteristicSViewTable(_))
  ...
  private def getDBIO(objects: String, rp: ResultParam, plain: Boolean = true): DBIO[Seq[ZooObject]] = {
    (objects, plain) match {
      case ("tbMatrixWithCharacteristicS", true) => MatrixWithCharacteristicSPlainQuery.get(rp)
      case ("tbMatrixWithCharacteristicS", false) => tbMatrixWithCharacteristicS.dynamicQueryResults(rp).result
      case ("tbMatrixWithCharacteristicSView", true) => MatrixWithCharacteristicSViewPlainQuery.get(rp)
      case ("tbMatrixWithCharacteristicSView", false) => tbMatrixWithCharacteristicSView.dynamicQueryResults(rp).result
  ...
  private def countDBIO(objects: String, qp: SearchParam, plain: Boolean = true): DBIO[Int] = {
    (objects, plain) match {
      case ("tbMatrixWithCharacteristicS", true) => MatrixWithCharacteristicSPlainQuery.count(qp)
      case ("tbMatrixWithCharacteristicS", false) => tbMatrixWithCharacteristicS.dynamicQueryCount(qp).length.result
      case ("tbMatrixWithCharacteristicSView", true) => MatrixWithCharacteristicSViewPlainQuery.count(qp)
      case ("tbMatrixWithCharacteristicSView", false) => tbMatrixWithCharacteristicSView.dynamicQueryCount(qp).length.result
